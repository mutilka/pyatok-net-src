...
Понял. Вот вся информация в Markdown, но без использования символов ` (тройных обратных кавычек) для форматирования блоков кода. Вместо этого я буду использовать 4 пробела для каждого уровня отступа, чтобы Markdown интерпретировал это как код.
...
Надеюсь, эта подробная инструкция 