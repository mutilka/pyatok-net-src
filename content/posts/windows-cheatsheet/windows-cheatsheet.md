...
### Три простых шага для автозапуска приложения:
  ...
  - Шаг 1 Создаем новую задачу
    ...
    ![Автозапуск приложения](img/04-windows-cheatsheet.png)

  - Шаг 2 Добавляем триггер запуска

    ![Автозапуск приложения](img/05-windows-cheatsheet.png)

  - Шаг 3 Указываем действие для задачи

    ![Автозапуск приложения](img/06-windows-cheatsheet.png)
