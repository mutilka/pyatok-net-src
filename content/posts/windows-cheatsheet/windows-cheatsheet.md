...
## Как сделать переименование файлов по клавише f2?
...
2. Выберите в выпадающем списке клавишу f2 и введите в поле "команда":

```
cm_RenameOnly
```

![Планировщик заданий](img/07-windows-cheatsheet.jpg)
