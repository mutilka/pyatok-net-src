...
Транзисторы лежат в самом сердце современных электронных технологий. Разработка биполярного транзистора или биполярного транзистора с переходом (BJT) привела к множеству изменений в мире.
