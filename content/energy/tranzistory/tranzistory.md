...
lastmod: 2026-02-03T00:00:02+03:00
draft: false
tags: ["Электроника", "Компоненты", "Транзисторы"]
# categories: ["Hello World"]
series: ["Электронные компоненты"]
# weight: 1
...
## Как легко запомнить NPN или PNP транзистор изображён на схеме?

![Как определить тип транзистора на схеме](img/pnp-npn-transistor-new.png)

> Подсказка:
> Нужно запомнить английский акроним "Not > Pointing iN" (NPN) что в переводе означает > "Не указывает внутрь" и это относится к > стрелке!

{{% spoiler title="Правильный ответ под спойлером!" %}}
a – PNP
b – NPN
{{% /spoiler %}}